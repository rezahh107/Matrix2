...
- فایل‌های **Inspactor** و **Schools** باید شیت هدف خود را در اولین صفحه داشته باشند؛ تابع `read_excel_first_sheet` همین شیت نخست را می‌خواند.【F:app/infra/io_utils.py†L93-L118】
