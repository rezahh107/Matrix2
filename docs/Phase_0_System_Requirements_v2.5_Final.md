...
- **FR-MENT-07 — ثبت دلایل سیاستی:** برای هر پشتیبانی که خارج از استخر نگه داشته می‌شود باید در خروجی trace/گزارش مدیریتی ستونی وجود داشته باشد که وضعیت و دلیل Policy (مثلاً `FROZEN (Policy v1.0.3)`) را نشان دهد تا ممیزی بدون مراجعه به Excel امکان‌پذیر باشد.
