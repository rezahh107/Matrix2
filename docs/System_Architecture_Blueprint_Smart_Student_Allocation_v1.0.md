...
- **UI Responsibilities:**
  ...
  - این پنل همچنین پیشنهادهای HistoryStore (مثلاً «این پشتیبان در سال جاری سهم خود را پر کرده است») را نشان می‌دهد؛ تصمیم نهایی و اعمال‌شدن فقط زمانی معتبر است که تغییر در SSoT ذخیره شود.
